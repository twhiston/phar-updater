...
class UpdaterBitbucketStrategyTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function setup()
    {
        ...
        $this->updater = new Updater($this->files . '/test.phar', false, Updater::STRATEGY_BITBUCKET);
    }
    ...
    public function testUpdatePhar()
    {
        ...
        $updater->setStrategyObject(new BitbucketTestStrategy);
...
class BitbucketTestStrategy extends BitbucketStrategy
{
